...
<html lang="en">
  ...
  <body>
  	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
		      <a class="navbar-brand" href="index.html"><span class="flaticon-pizza-1 mr-1"></span>Pizza<br><small>House</small></a>
    ...
    <footer class="ftco-footer ftco-section img" style='background: #fac564; padding-top: 50px; padding-bottom: 50px;'>
    	<div class="overlay"></div>
      <div class="container">
        <!-- <div class="row mb-5">
